...
namespace CapaPresentacionAdmin.Controllers
{
    ...
    public class MantenedorController : Controller
    {
        ...
        public JsonResult GuardarProducto(string objeto, HttpPostedFileBase archivoImagen)
        {
            ...
            oProducto = JsonConvert.DeserializeObject<Producto>(objeto); //convertimos el objeto q es string a Producto.

            //validamos el precio que entra
            decimal precio;
            ...
            {
                //para guardar imagen y actualizar en tabla 
                if (archivoImagen != null)
                {
                    ...
                    try
                    {
                        archivoImagen.SaveAs(Path.Combine(ruta_guardar, nombre_imagen)); //especifico donde guardamos la imagen 
                    }
                    catch (Exception ex)
                    {
            ...
            //---- REGISTRAMOS HASTA ACA 

        }



        //--- METODO PARA REGISTRAR LA IMAGEN DEL PRODUCTO CON EL METODO DE RECURSOS PARA QUE SEA BASE64 LA IMAGEN 
        [HttpPost]
        public JsonResult ImagenProducto(int id)
        {
            ...
            //Retornamos la conversion obtenida de la imagen en base64 para pintaro desde javascripts en producto.cshtml
        }
